...
import { AccountStatus, NotificationType, Role } from 'src/common/enums/domain.enums';
...
describe('Stock alert flow (e2e)', () => {
  ...
  it('triggers low stock notification after stock update', async () => {
    ...
    const lowStock = notifications.body.find(
      (item: { type?: NotificationType }) => item.type === NotificationType.STOCK_BAS
    );
